...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/emit/': RouteRecordInfo<'/emit/', '/emit', Record<never, never>, Record<never, never>>,
    '/emit/child': RouteRecordInfo<'/emit/child', '/emit/child', Record<never, never>, Record<never, never>>,
    '/emit/child2': RouteRecordInfo<'/emit/child2', '/emit/child2', Record<never, never>, Record<never, never>>,
